...
from magic_pdf.model.sub_modules.model_init2 import (
    ...
    UnimernetModelWrapper, YOLOv8MFDModelWrapper, get_cached_model)
...
class TestModelWrappers(unittest.TestCase):
    def test_struct_table_model_wrapper(self):
        ...
        wrapper = StructTableModelWrapper(model_path="path/to/model", max_time=60)
    ...
    def test_table_master_paddle_model_wrapper(self):
        ...
        wrapper = TableMasterPaddleModelWrapper(config={"model_dir": "path/to/model", "device": "cpu"})
        wrapper.model = mock_model
        result = wrapper.predict("input_data")
    ...
    def test_unimernet_model_wrapper(self):
        ...
        wrapper = UnimernetModelWrapper(weight_dir="path/to/weight", cfg_path="path/to/config", device="cpu")
        wrapper.model = mock_model
        result = wrapper.predict("input_data")
    ...
    def test_layoutlmv3_predictor_wrapper(self):
        ...
        wrapper = Layoutlmv3_PredictorWrapper(weight="path/to/weight", config_file="path/to/config", device="cpu")
        wrapper.model = mock_model
        result = wrapper.predict("input_data")
    ...
    def test_doclayout_yolo_model_wrapper(self):
        ...
        wrapper = DocLayoutYOLOModelWrapper(weight="path/to/weight", device="cpu")
        wrapper.model = mock_model
        result = wrapper.predict("input_data")
    ...
    def test_modified_paddle_ocr_wrapper(self):
        ...
        wrapper = ModifiedPaddleOCRWrapper(show_log=False, det_db_box_thresh=0.3, lang="en", use_dilation=True, det_db_unclip_ratio=1.8)
        wrapper.model = mock_model
        result = wrapper.predict("input_data")
...
class TestModelFactory(unittest.TestCase):
    ...
    def test_create_table_model_struct_eqtable(self, MockStructTableModelWrapper):
        ...
        model = ModelFactory.create_model(AtomicModel.Table, table_model_name=MODEL_NAME.STRUCT_EQTABLE, table_model_path="path/to/model", table_max_time=60, device="cpu")
    ...
    def test_create_table_model_table_master(self, MockTableMasterPaddleModelWrapper):
        ...
        model = ModelFactory.create_model(AtomicModel.Table, table_model_name=MODEL_NAME.TABLE_MASTER, table_model_path="path/to/model", device="cpu")
        self.assertEqual(model, mock_model)
    ...
    def test_create_table_model_rapid_table(self, MockRapidTableModelWrapper):
        ...
        model = ModelFactory.create_model(AtomicModel.Table, table_model_name=MODEL_NAME.RAPID_TABLE)
        self.assertEqual(model, mock_model)
    ...
    def test_create_mfd_model(self, MockYOLOv8MFDModelWrapper):
        ...
        model = ModelFactory.create_model(AtomicModel.MFD, mfd_weights="path/to/weight", device="cpu")
        self.assertEqual(model, mock_model)
    ...
    def test_create_mfr_model(self, MockUnimernetModelWrapper):
        ...
        model = ModelFactory.create_model(AtomicModel.MFR, mfr_weight_dir="path/to/weight", mfr_cfg_path="path/to/config", device="cpu")
        self.assertEqual(model, mock_model)
    ...
    def test_create_ocr_model(self, MockModifiedPaddleOCRWrapper):
        ...
        model = ModelFactory.create_model(AtomicModel.OCR, show_log=False, det_db_box_thresh=0.3, lang="en", use_dilation=True, det_db_unclip_ratio=1.8)
        self.assertEqual(model, mock_model)
    ...
    def test_create_layout_model_layoutlmv3(self, MockLayoutlmv3PredictorWrapper):
        ...
        model = ModelFactory.create_model(AtomicModel.Layout, layout_model_name=MODEL_NAME.LAYOUTLMv3, layout_weights="path/to/weight", layout_config_file="path/to/config", device="cpu")
        self.assertEqual(model, mock_model)
    ...
    def test_create_layout_model_doclayout_yolo(self, MockDocLayoutYOLOModelWrapper):
        ...
        model = ModelFactory.create_model(AtomicModel.Layout, layout_model_name=MODEL_NAME.DocLayout_YOLO, doclayout_yolo_weights="path/to/weight", device="cpu")
        self.assertEqual(model, mock_model)
...
class TestAtomModelSingleton(unittest.TestCase):
    ...
    def test_get_atom_model(self, MockGetCachedModel):
        ...
        model = singleton.get_atom_model(AtomicModel.Table, table_model_name=MODEL_NAME.STRUCT_EQTABLE, table_model_path="path/to/model", table_max_time=60, device="cpu")
        self.assertEqual(model, mock_model)
